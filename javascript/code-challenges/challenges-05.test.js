...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((runningTotal, currentValue) => runningTotal = runningTotal + currentValue.purchasePrice, 0);
};
...
const countNumberOfElements = (arr) => {
  return arr.reduce((runningTotal) => runningTotal + 1, 0);
};
...
const countNumberOfChildren = (arr) => {
  ...
  arr.filter(person => {
    if (person.children){
      kids.push(person.children.length);
    }
  });
  return kids.flat().reduce((runningTotal, currentValue) => runningTotal + currentValue, 0);
};
...
const calculateAverage = (arr) => {
  ...
  return arr.reduce((runningTotal, currentValue) => runningTotal + currentValue, 0) / length;
};
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  let prime = [];
  prime = arr.map(num => isPrime(num)).filter((elem) => elem === true);
  return prime.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
};
