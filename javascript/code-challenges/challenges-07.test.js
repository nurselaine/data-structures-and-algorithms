...
const gruffaloCrumble = {
  ...
  ingredients: [
    ...
    '8 pounds oats',
    '2 pounds brown sugar', // 2
    '4 pounds flour',
    '2 gallons pure maple syrup', //4 pure maple syrup
    '16 cups chopped nuts', // 5 chopped nuts
    '1 pound baking soda', // 6
    '1 pound baking powder', // 7
    '1 pound cinnamon',
    '6 gallons melted butter', // 9 melted butter
    '2 gallons fresh water', // 10 fresh water
  ],
  steps: [
